  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          { src: 'icons/d-route-mark.svg?v=2.1.1-RC3', sizes: 'any', type: 'image/svg+xml', purpose: 'any' },
          { src: 'icons/d-route-maskable.svg?v=2.1.1-RC3', sizes: 'any', type: 'image/svg+xml', purpose: 'maskable' }
        ]
      },
      workbox: {
